# useful for printing out the field values of one or more objects you specify by ID
#
...
for id in ids:
    ...
    if len(results) == 0:
        results = catalog.searchResults(portal_type='OIEStudyAbroadStudentApplication', id=id)
        new_style = True
    if len(results) > 1:
        print 'too many catalog query results (%s) for ID %s' % (len(results), id)
        return printed
    if len(results) != 1:
        print 'no catalog query results for ID %s' % (id)
        return printed
    r = results[0]
    o = r.getObject()
    if not new_style:
        ...
        (created, modified, getDepartureDate, getReturnDate, getOrientationDate1, getOrientationDate2, getConflictDate, getCompletionDate) = (o.created(), o.modified(), o.departureDate, o.returnDate, o.orientationDate1, o.orientationDate2, o.conflictDate, o.completionDate)
    if created is not None and created != '':
        created = hasattr(created, 'ISO8601') and created.ISO8601() or created
    if modified is not None and modified != '':
        modified = hasattr(modified, 'ISO8601') and modified.ISO8601() or modified
    if getDepartureDate is not None and getDepartureDate != '':
        getDepartureDate = hasattr(getDepartureDate, 'ISO8601') and getDepartureDate.ISO8601() or getDepartureDate
    if getReturnDate is not None and getReturnDate != '':
        getReturnDate = hasattr(getReturnDate, 'ISO8601') and getReturnDate.ISO8601() or getReturnDate
    if getOrientationDate1 is not None and getOrientationDate1 != '':
        getOrientationDate1 = hasattr(getOrientationDate1, 'ISO8601') and getOrientationDate1.ISO8601() or getOrientationDate1
    if getOrientationDate2 is not None and getOrientationDate2 != '':
        getOrientationDate2 = hasattr(getOrientationDate2, 'ISO8601') and getOrientationDate2.ISO8601() or getOrientationDate2
    if getConflictDate is not None and getConflictDate != '':
        getConflictDate = hasattr(getConflictDate, 'ISO8601') and getConflictDate.ISO8601() or getConflictDate
    if getCompletionDate is not None and getCompletionDate != '':
        getCompletionDate = hasattr(getCompletionDate, 'ISO8601') and getCompletionDate.ISO8601() or getCompletionDate
    getProgramName = hasattr(o, 'getProgramName') and o.getProgramName() or o.programName
    if getProgramName is not None and getProgramName != '':
        getProgramName = hasattr(getProgramName, 'Title') and getProgramName.Title() or getProgramName
    ...
    if not new_style:
        ...
        print [o.id, r.review_state, o.listCreators(), created, modified, o.studentID, o.firstName, o.middleName, o.lastName, o.email, o.localAddr1, o.localAddr2, o.localCity, o.localState, o.localZip, o.localCountry, o.localPhone, o.mobilePhone, o.homeAddr1, o.homeAddr2, o.homeCity, o.homeState, o.homeZip, o.homeCountry, o.homePhone, o.citizenship, o.citizenshipOther, o.stateResidency, o.stateResidencyOther, o.dateOfBirth_year, o.dateOfBirth_month, o.dateOfBirth_day, o.placeOfBirth, o.gender, o.marriageStatus, o.ethnicity, o.ethnicityOther, o.passportName, o.passportNumber, o.passportIssueOffice, o.passportExpDate, o.passportExpDate, o.passportExpDate, o.questionAcadCareerPlan, o.questionLangCulturalSkills, o.questionPrevTravel, o.questionWorkExp, o.questionEuroBizTravSem, o.questionStuExchComp, o.doctorLastname, o.doctorFirstname, o.doctorPhone, o.medicalInsuranceCompany, o.medicalPolicyHolder, o.medicalPolicyGroupNumber, o.foodAllergies, o.hasDifficultyWalking, o.maxWalkingDistance, o.medicalReadStatement, o.medicalHealthProblems, o.medicalHealthProblems_takenMedication, o.medicalHealthProblems_medications, o.medicalHealthProblems_stable, o.medicalHealthProblems_underCare, o.medicalHealthProblems_whatCondition, o.medicalHealthProblems_willingToPrescribe, o.medicalHealthProblems_additionalInfo, o.medicalMentalProblems, o.medicalMentalProblems_takenMedication, o.medicalMentalProblems_medications, o.medicalMentalProblems_currentDose, o.medicalMentalProblems_stable, o.medicalMentalProblems_underCare, o.medicalMentalProblems_condition, o.medicalMentalProblems_enoughMedication, o.medicalMentalProblems_additionalInfo, o.medicalRegistered, o.medicalRegistered_office, o.medicalRegistered_accommodations, o.medicalAccessOK, o.smokingPreferred, o.isVegetarian, o.additionalNeeds, o.emerg1name, o.emerg1addr1, o.emerg1addr2, o.emerg1city, o.emerg1state, o.emerg1zip, o.emerg1country, o.emerg1homePhone, o.emerg1workPhone, o.emerg1mobilePhone, o.emerg1email, o.emerg2name, o.emerg2addr1, o.emerg2addr2, o.emerg2city, o.emerg2state, o.emerg2zip, o.emerg2country, o.emerg2homePhone, o.emerg2workPhone, o.emerg2mobilePhone, o.emerg2email, o.emerg3name, o.emerg3addr1, o.emerg3addr2, o.emerg3city, o.emerg3state, o.emerg3zip, o.emerg3country, o.emerg3homePhone, o.emerg3workPhone, o.emerg3mobilePhone, o.emerg3email, getProgramName, o.programYear, o.programSemester, o.studentType, o.universityEnrolled, o.graduationMonth, o.graduationYear, o.cumulativeGPA, o.major1, o.major2, o.minor1, o.minor2, o.emphasis1, o.emphasis2, o.willTakeBus, o.willFlyWithGroup, getDepartureDate, getReturnDate, o.agreeToCosts, getOrientationDate1, o.orientationHours1, getOrientationDate2, o.orientationHours2, o.numberOfGuests, o.orientationConflict, getConflictDate, o.subject1, o.course1, o.credits1, o.subject2, o.course2, o.credits2, o.subject3, o.credits3, o.subject4, o.course4, o.credits4, o.subject5, o.course5, o.credits5, o.subject6, o.course6, o.credits6, o.readSyllabus, o.enrolledIS333, o.applyForAid, o.holdApplication, o.financialAidGranted, o.roomType, o.roommateName1, o.roommateName2, o.questionExpectations, o.awareOfAllMaterials, o.UWOshkoshRelease, o.certification, o.seatNumber, getCompletionDate, o.applicationIsComplete, o.applicationFeeOK, o.UWSystemStatementOK, o.UWOshkoshStatementOK, o.withdrawalRefund, o.transcriptsOK, o.programSpecificMaterialsRequired, o.programSpecificMaterialsOK, o.specialStudentFormRequired, o.specialStudentFormOK, o.creditOverloadFormRequired, o.creditOverloadFormOK, o.medicalOK, o.medicalForm, o.passportOK, o.metPassportDeadline, o.programSpecificMaterialsRequiredStepIII, o.programSpecificMaterialsOKStepIII, o.attendedOrientation, o.cisiDates, o.cisiNumberOfMonths, o.programFee, o.tuitionPayment, o.depositOnTime, o.payment2OnTime, o.applicationFeeRefund, o.foreignCourse1, o.foreignCourse2, o.foreignCourse3, o.foreignCourse4, o.foreignCourse5, o.foreignCourse6, o.papersOK, o.noMoreMaterials, o.programMaterials, o.programFee2, review_history]
    print ","
print "]"
return printed
