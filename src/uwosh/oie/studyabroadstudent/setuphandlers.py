...
def post_install(context):
    ...
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Academic Programs International (API)')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Accent International')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='American Institute for Foreign Study (AIFS)')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='AMIDEAST')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Amizade Ltd.')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Anglo Educational Services')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Anytour International')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Beyond Borders International / Minds Abroad')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Cultural Experiences Abroad (CEA)')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Customized Educational Programs Abroad (CEPA)')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='China Sense')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Council on International Educational Exchange (CIEE)')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='CISabroad')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Destination Partners')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Educators Abroad Ltd')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='EF College Study Tours')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='EIL Intercultural Learning')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Fellowship Travel')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Global Academic Ventures')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Global Engagement Institute')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Happy Tours - Peru')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Inspiration India')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='International Studies Abroad (ISA)')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='International Study Programs (ISP)')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='International Volunteer HQ (IVHQ)')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Operation Groundswell')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Palace Travel')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Rama Tours')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Select Travel Study')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Seminars International')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Spanish Learning')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Vesna Tours')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='VIDA Volunteer')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='World Endeavors')
    api.content.create(type='OIECooperatingPartner', container=partner_folder, title='Worldstrides Capstone')
