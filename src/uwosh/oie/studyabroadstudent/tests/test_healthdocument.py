...
from uwosh.oie.studyabroadstudent.interfaces.healthdocument import IOIEHealthSafetySecurityDocument
...
class OIEHealthSafetySecurityDocumentIntegrationTest(unittest.TestCase):
    ...
    def test_schema(self):
        fti = queryUtility(IDexterityFTI, name='OIEHealthSafetySecurityDocument')
