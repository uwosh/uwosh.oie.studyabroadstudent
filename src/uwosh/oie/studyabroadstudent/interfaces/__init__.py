...
from uwosh.oie.studyabroadstudent.interfaces.emailtemplate import IOIEParticipantEmailTemplate  # noqa
from uwosh.oie.studyabroadstudent.interfaces.emailtemplate import IOIEProgramEmailTemplate  # noqa
