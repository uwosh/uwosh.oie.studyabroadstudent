...
REQUIRED_VALUE_IN_STATE_KEY = 'uwosh.oie.studyabroadstudent.required-value-in-state'
...
E_SYLLABUS_AND_SUPPORTING_DOCS = 'uwosh.oie.studyabroadstudent.edit.syllabus_and_supporting_docs'
V_ACADEMIC_PROGRAM_FS = 'uwosh.oie.studyabroadstudent.view.academic_program_fieldset'
E_ACADEMIC_PROGRAM_FS = 'uwosh.oie.studyabroadstudent.edit.academic_program_fieldset'
V_DATES_DESTINATIONS_FS = 'uwosh.oie.studyabroadstudent.view.dates_destinations_fieldset'
E_DATES_DESTINATIONS_FS = 'uwosh.oie.studyabroadstudent.edit.dates_destinations_fieldset'
V_DEPARTURE_FLIGHT_FS = 'uwosh.oie.studyabroadstudent.view.departure_flight_fieldset'
E_DEPARTURE_FLIGHT_FS = 'uwosh.oie.studyabroadstudent.edit.departure_flight_fieldset'
V_DEPARTURE_FROM_OSHKOSH_FS = 'uwosh.oie.studyabroadstudent.view.departure_from_oshkosh_fieldset'
E_DEPARTURE_FROM_OSHKOSH_FS = 'uwosh.oie.studyabroadstudent.edit.departure_from_oshkosh_fieldset'
...
V_RETURN_TO_OSHKOSH_FS = 'uwosh.oie.studyabroadstudent.view.return_to_oshkosh_fieldset'
E_RETURN_TO_OSHKOSH_FS = 'uwosh.oie.studyabroadstudent.edit.return_to_oshkosh_fieldset'
V_PARTICIPANT_SELECTION_FS = 'uwosh.oie.studyabroadstudent.view.participant_selection_fieldset'
E_PARTICIPANT_SELECTION_FS = 'uwosh.oie.studyabroadstudent.edit.participant_selection_fieldset'
V_LIAISON_AND_LEADERSHIP_FS = 'uwosh.oie.studyabroadstudent.view.liaison_and_leadership_fieldset'
E_LIAISON_AND_LEADERSHIP_FS = 'uwosh.oie.studyabroadstudent.edit.liaison_and_leadership_fieldset'
