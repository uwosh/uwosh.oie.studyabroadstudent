...
# Contents listing appears at the bottom & shows any contained items such
# as documents
...
# Define permissions (read, read/write, or nothing) for each workflow role
# and state pair. Can do this at the entire object level, at the fieldset
...
VIEWABILITY = {
    ...
    'Mgmt_Dean': {
        'applicants-considering-change': NOTHING,
        'application-intake-in-progress': NOTHING,
        'cancelled': NOTHING,
        'declined': NOTHING,
        'final-payment-billing-in-progress': NOTHING,
        'final-program-accounting-in-progress': NOTHING,
        'incident-in-progress': NOTHING,
        'initial': NOTHING,
        'initial-payment-billing-in-progress': NOTHING,
        'pending-arrival-abroad': NOTHING,
        'pending-chair-review': NOTHING,
        'pending-dean-unit-director-review': NOTHING,
        'pending-discussions-with-program-manager': NOTHING,
        'pending-final-program-fee': NOTHING,
        'pending-oie-review': NOTHING,
        'pending-program-departure': NOTHING,
        'pending-program-fee-determination-by-oie': NOTHING,
        'pending-program-leader-operational-briefing': NOTHING,
        'pending-program-leader-orientation': NOTHING,
        'pending-provider-responses': NOTHING,
        'pending-provost-review': NOTHING,
        'pending-travel-advance': NOTHING,
        'process-refunds-budget-transfers': NOTHING,
        'program-completed': NOTHING,
        'program-fee-pending-publication': NOTHING,
        'program-fee-under-liaison-review': NOTHING,
        'program-in-progress': NOTHING,
        'provider-proposals-under-liaison-review': NOTHING,
        'provider-proposals-under-oie-review': NOTHING,
        'request-for-proposals-under-development': NOTHING,
        'request-for-proposals-under-liaison-review': NOTHING,
        'reviewing-final-program-details': NOTHING,
        'suspended': NOTHING,
        'travel-expense-report-student-evaluations-due-to': NOTHING,
        'withdrawn': NOTHING,
    },
    'Mgmt_DeanDirector': {
        'applicants-considering-change': READ_WRITE,
    ...
    'Mgmt_Director': {
        'applicants-considering-change': {  # field-level permissions
            SHOW_CONTENTS: READ,
        ...
        'pending-chair-review': {
            ...
            SHOW_FIELDSETS: {  # an example of fieldset-level permissions
                'comments_fieldset': READ,
    ...
    # built in roles
    'Anonymous': {  # an example of object-level permissions
        'applicants-considering-change': NOTHING,
        'application-intake-in-progress': NOTHING,
        'cancelled': NOTHING,
        'declined': NOTHING,
    ...
    'Manager': {
        ...
        'request-for-proposals-under-liaison-review': READ_WRITE,
        'reviewing-final-program-details': READ_WRITE,
        'suspended': READ_WRITE,
        'travel-expense-report-student-evaluations-due-to': READ_WRITE,
        'withdrawn': READ_WRITE,
    },
    'Member': {
        'applicants-considering-change': NOTHING,
        'application-intake-in-progress': NOTHING,
