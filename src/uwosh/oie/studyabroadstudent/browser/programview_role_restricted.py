...
# set this to False if you want to control the visibility and editability of each field, regardless of the object's
...
VIEWABILITY = {
    ...
    'Mgmt_Director' : {
        ...
        'pending-chair-review' : {
            ...
            'graduate_registration_form_and_graduate_special_non_degree_information_form' : NOTHING,
            ...
            'spring_interim_summer_fall_semester_participant_orientation_deadline' : NOTHING,
            'spring_interim_summer_fall_semester_in_person_orientation' : NOTHING,
            'winter_interim_spring_semester_participant_orientation_deadline' : NOTHING,
